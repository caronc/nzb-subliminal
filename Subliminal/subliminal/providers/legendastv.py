...
from ..exceptions import ProviderAuthenticationError, ProviderConfigurationError, ProviderError, ProviderNotAvailable
from ..subtitle import SUBTITLE_EXTENSIONS, Subtitle, compute_guess_matches
...
class LegendasTVSubtitle(Subtitle):
    ...
    def __init__(self, language, type, title, year, imdb_id, season, archive, name, hearing_impaired):
        super(LegendasTVSubtitle, self).__init__(language, hearing_impaired)
        self.type = type
        self.title = title
        self.year = year
    ...
    def get_matches(self, video, hearing_impaired=False):
        ...
        # name
        matches |= compute_guess_matches(video, guess_info(self.name))
...
class LegendasTVProvider(Provider):
    ...
    def __init__(self, username=None, password=None):
        ...
        # Provider needs UNRAR installed. If not available raise ProviderConfigurationError
        try:
    ...
    def initialize(self):
        ...
        if self.username and self.password:
            ...
            if soup.find('div', {'class': 'alert-error'}, string=re.compile(u'Usuário ou senha inválidos')):
                raise ProviderNotAvailable(self.username)
    ...
    def get_archives(self, title_id, language_code, title_type, season, episode):
        ...
        while True:
            ...
            # parse the results
            soup = bs4.BeautifulSoup(r.content, ['permissive'])
    ...
    def list_subtitles(self, video, languages):
        ...
        elif hasattr(video, 'alternative_titles'):
    ...
    def download_subtitle(self, subtitle):
        ...
        subtitle.content = subtitle.archive.content.read(subtitle.name)
